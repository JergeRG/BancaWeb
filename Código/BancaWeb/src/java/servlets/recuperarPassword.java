...
public class recuperarPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(negocios.buscaUsuario(usuario, url)){
             email = negocios.buscaEmail1(usuario, url);
             String pass = negocios.buscaPassword(usuario, url);
             String asunto = "Recuperación de contraseña";
             String mensaje = "Se ha solicitado el recuperar su contraseña:\n\n"
                    + "Usuario: " + usuario + "\nPassword: " + pass;
            ...
            response.sendRedirect("recuperare.html");
        }
