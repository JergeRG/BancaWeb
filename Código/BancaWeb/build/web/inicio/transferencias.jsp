<%-- 
    ...
    Created on : 01-dic-2018, 15:25:05
    Author     : Jorge
--%>
          ...
          <form action="../realizarTransferencia">
            <div class="form-row">
              <div class="form-group col-md-6">
                <input type="text" name="cuenta" class="form-control" id="name" placeholder="Cuenta a la que desea transferir: (XXXXXX)" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validation"></div>
              </div>
              <div class="form-group col-md-6">
                <input type="text" class="form-control" name="cantidad" id="email" placeholder="Monto a transferir: ($XXX.XX)" data-rule="email" data-msg="Please enter a valid email" />
                <div class="validation"></div>
              </div>
            </div>
            <div class="form-group">
              <input type="password" class="form-control" name="nip" id="subject" placeholder="NIP: (XXXX)" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
              <div class="validation"></div>
            </div>
