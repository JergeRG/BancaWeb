<%-- 
    ...
    Created on : 02-dic-2018, 20:27:58
    Author     : Jorge
--%>
...
<body id="body">
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
          <h1><a href="#body" class="scrollto">Banca<span>Web-</span><a href="Cuentas.jsp"><span id = "status">${cuenta}</span></a></a></h1>
      </div>
  ...
  <script src="js/rutina2.js"></script>
