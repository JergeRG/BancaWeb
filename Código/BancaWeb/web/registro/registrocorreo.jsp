<%-- 
    Document   : registrocorreo
    Created on : 29-nov-2018, 8:15:26
    Author     : Jorge
--%>
...
<%
    ...
    sesion.setAttribute("usuario1", usuario);
		...
		<div class="wrap-contact100" >
			<div class="contact100-form-title" style="background-image: url(images/bg-01.jpg);" >
				<span class="contact100-form-title-1">
                        ...
                        <div class="error"><center><b>Ya existe una cuenta con el correo con el cual que deseas registrarte, elige otro</b></center></div>
			<form class="contact100-form validate-form" action="../ingresarUsuario">
				<div class="wrap-input100 validate-input" data-validate="Debe ingresar un nombre valido">
					...
					<input class="input100" type="text" name="nombre" value ="${nombre}" placeholder="Nombre (la primer letra debe ir mayúcula)">
                ...
                <div class="wrap-input100 validate-input" data-validate="Debe ingresar apellidos validos">
                 <span class="label-input100">Apellidos</span>
					<input class="input100" type="text" name="apellidos" value ="${apellidos}" placeholder="Apellidos (la primer letra debe ir mayúcula)">
					<span class="focus-input100"></span>
                </div>
				<div class="wrap-input100 validate-input" data-validate="Debe ingresar un usuario valido">
					<span class="label-input100">Usuario</span>
					<input class="input100" type="text" name="username" value ="${usuario1}" placeholder="Usuario (entre 3 y 10 caracteres)">
					<span class="focus-input100"></span>
				</div>
                 <div class="wrap-input100 validate-input" data-validate="Debe contener: Minimo 8 caracteres/Maximo 15/Al menos una letra mayúscula/Al menos una letra minucula/Al menos un dígito/No espacios en blanco/Al menos 1 caracter especial">
                 <span class="label-input100">Contraseña</span>
					<input class="input100" type="password" id ="pass1" name="password" class="validate" placeholder="8-15 caracteres (Ejemplo1$)">
                     
					<span class="focus-input100"></span>
                </div>
				<div class="wrap-input100 validate-input" data-validate="Las contraseñas deben coincidir">
				...
				<div class="wrap-input100 validate-input" data-validate = "Debe ingresar un correo valido: ejemplo@abc.com">
					...
					<input class="input100" type="text" name="email"  placeholder="Ingrese su direccion email" >
					<span class="focus-input100"></span>
				</div>
